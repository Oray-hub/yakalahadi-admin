...
function BulkNotification({ onClose }: BulkNotificationProps) {
  ...
  const handleExampleClick = (exampleTitle: string, exampleMessage: string) => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Toplu Bildirim Merkezi</h1>
          </div>
          <p className="text-lg text-gray-600">
            Tüm kullanıcılara bildirim gönderin
          </p>
          <button
            onClick={onClose}
            className="mt-4 px-4 py-2 text-gray-500 hover:text-gray-700 text-sm font-medium flex items-center mx-auto"
          >
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                <div 
                  ...
                  onClick={() => handleExampleClick("Yeni Kampanya Başladı!", "Yeni kampanyalarımızı kaçırmayın! Hemen kontrol edin.")}
                >
                  <div className="flex items-center">
                ...
                <div 
                  className="bg-gray-50 rounded-lg p-3 cursor-pointer hover:bg-gray-100 transition-colors border border-gray-200"
                  onClick={() => handleExampleClick("Sistem Bakımı", "Sistem bakımı nedeniyle 2 saat boyunca hizmet veremeyeceğiz.")}
                >
                  <div className="flex items-center">
                ...
                <div 
                  className="bg-gray-50 rounded-lg p-3 cursor-pointer hover:bg-gray-100 transition-colors border border-gray-200"
                  onClick={() => handleExampleClick("Yeni Özellikler", "Yeni özellikler eklendi! Uygulamayı güncelleyin.")}
                >
                  <div className="flex items-center">
